...
local isStudio
local website = "github.com/Nebula-Softworks" -- coder
-- stealled by coldteam x
...
local IconModule = {
	...
	Material = {
		...
		["coldteamx"] = "http://www.roblox.com/asset/?id=125807422578362";
...
-- ═══════════════════════════════════════════════════════════════════
-- FLUENT-STYLE API WRAPPER
-- Dùng như Fluent nhưng render bằng Luna bên trong
-- ═══════════════════════════════════════════════════════════════════

local _LunaLib = Luna

local Fluent = {}
Fluent.Options = _LunaLib.Options

function Fluent:CreateWindow(opts)
    opts = opts or {}
    local win = _LunaLib:CreateWindow({
        Name            = opts.Title or opts.Name or "Window",
        Subtitle        = opts.SubTitle or opts.Subtitle or "",
        LogoID          = opts.Icon or "6031097225",
        LoadingEnabled  = opts.LoadingEnabled ~= false,
        LoadingTitle    = opts.LoadingTitle or opts.Title or "Loading",
        LoadingSubtitle = opts.LoadingSubtitle or "",
        KeySystem       = opts.KeySystem or false,
        KeySettings     = opts.KeySettings or {},
        ConfigSettings  = opts.ConfigSettings or {},
    })
    ...
    function W:AddTab(o)
        ...
        local tab = win:CreateTab({
            ...
            Icon        = o.Icon or "view_in_ar",
            ImageSource = o.ImageSource or "Material",
        })
        ...
        function T:AddToggle(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateToggle({
                Name         = o2.Title or o2.Name or flag or "Toggle",
                Description  = o2.Description or o2.Subtitle,
                CurrentValue = o2.Default or o2.CurrentValue or false,
                Callback     = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end

        function T:AddButton(o2)
            o2 = o2 or {}
            return tab:CreateButton({
                Name        = o2.Title or o2.Name or "Button",
                Description = o2.Description or o2.Subtitle,
                Callback    = o2.Callback or function() end,
            })
        end

        function T:AddSlider(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateSlider({
                Name         = o2.Title or o2.Name or flag or "Slider",
                Description  = o2.Description or o2.Subtitle,
                Range        = o2.Range or {o2.Min or 0, o2.Max or 100},
                Increment    = o2.Increment or o2.Step or 1,
                CurrentValue = o2.Default or o2.CurrentValue or 0,
                Callback     = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end

        function T:AddDropdown(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateDropdown({
                Name            = o2.Title or o2.Name or flag or "Dropdown",
                Description     = o2.Description or o2.Subtitle,
                Options         = o2.Values or o2.Options or {},
                CurrentOption   = o2.Default or o2.CurrentOption,
                MultipleOptions = o2.Multi or o2.MultipleOptions or false,
                SpecialType     = o2.SpecialType,
                Callback        = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end

        function T:AddInput(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateInput({
                Name            = o2.Title or o2.Name or flag or "Input",
                Description     = o2.Description or o2.Subtitle,
                PlaceholderText = o2.Placeholder or o2.PlaceholderText or "",
                CurrentValue    = o2.Default or o2.CurrentValue or "",
                Numeric         = o2.Numeric or false,
                MaxCharacters   = o2.MaxCharacters,
                Enter           = o2.Enter or false,
                Callback        = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end
        T.AddTextbox = T.AddInput

        function T:AddColorpicker(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateColorPicker({
                Name     = o2.Title or o2.Name or flag or "Color",
                Color    = o2.Default or o2.Color or Color3.fromRGB(255,255,255),
                Callback = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end

        function T:AddKeybind(flag, o2)
            o2 = o2 or {}
            local el = tab:CreateBind({
                Name           = o2.Title or o2.Name or flag or "Keybind",
                Description    = o2.Description or o2.Subtitle,
                CurrentKeybind = o2.Default or o2.CurrentKeybind or "E",
                HoldToInteract = o2.HoldToInteract or false,
                Callback       = o2.Callback or function() end,
            }, flag)
            return (flag and _LunaLib.Options[flag]) or el
        end
        ...
        function T:AddLabel(text)
            return tab:CreateLabel({ Text = text or "" })
        end

        function T:AddParagraph(o2)
            o2 = o2 or {}
            return tab:CreateParagraph({
                Title = o2.Title or "",
                Text  = o2.Content or o2.Text or "",
            })
        end

        function T:AddDivider()
            return tab:CreateDivider()
        end

        function T:BuildConfigSection() return tab:BuildConfigSection() end
        function T:BuildThemeSection()  return tab:BuildThemeSection()  end
    ...
    function W:Init() end -- Luna tự init

    return W
end

_LunaLib.Fluent = Fluent
